...
from agents import Agent, ItemHelpers, handoff, Runner
...
async def main():
    ...
    print(r1.last_response_id)
    
    # input_list = r1.to_input_list()
    # for i in input_list:
    #     rich.print(i)
    
    # text = ItemHelpers.extract_last_text(r1.final_output)
