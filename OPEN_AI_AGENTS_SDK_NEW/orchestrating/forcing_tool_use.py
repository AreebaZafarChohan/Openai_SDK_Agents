...
# If you want to run this file so make sure you'll give tool_use_behaviour in command like this:
# uv run forcing_tool_use.py -t default
# uv run forcing_tool_use.py -t first_tool
# uv run forcing_tool_use.py -t custom
